...
%%
%% Outer tcolorbox: blue gradient frame (matches CodeImage VSCode Dark preset)
%% breakable so long listings split across pages; gradient re-drawn each segment
\\begin{{tcolorbox}}[
  enhanced, breakable,
  arc=12pt, outer arc=12pt,
  boxrule=0pt, frame hidden,
  toprule at break=0pt, bottomrule at break=0pt,
  interior style={{left color=vscGradStart, right color=vscGradEnd,
                  shading angle=135}},
  left=14pt, right=14pt, top=14pt, bottom=14pt,
]
  %% Inner tcolorbox: dark code panel (also breakable)
  \\begin{{tcolorbox}}[
    enhanced, breakable,
